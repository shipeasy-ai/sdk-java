...
public class GateTemplateRuleValue extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GateTemplateRuleValue.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GateTemplateRuleValue.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GateTemplateRuleValue' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GateTemplateRuleValue>() {
                @Override
                public void write(JsonWriter out, GateTemplateRuleValue value) throws IOException {
                ...
                @Override
                public GateTemplateRuleValue read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        GateTemplateRuleValue ret = new GateTemplateRuleValue();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for GateTemplateRuleValue: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GateTemplateRuleValue() {
        super("anyOf", Boolean.FALSE);
    }

    public GateTemplateRuleValue(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return GateTemplateRuleValue.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to GateTemplateRuleValue
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for GateTemplateRuleValue with anyOf schemas: BigDecimal, Boolean, List<Object>, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of GateTemplateRuleValue given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GateTemplateRuleValue
     * @throws IOException if the JSON string is invalid with respect to GateTemplateRuleValue
     */
    public static GateTemplateRuleValue fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, GateTemplateRuleValue.class);
    }

    /**
     * Convert an instance of GateTemplateRuleValue to an JSON string
     *
     * @return JSON string
     */
