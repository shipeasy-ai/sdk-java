...
import ai.shipeasy.admin.auth.Authentication;
import ai.shipeasy.admin.auth.HttpBasicAuth;
import ai.shipeasy.admin.auth.HttpBearerAuth;
import ai.shipeasy.admin.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    protected String basePath = "https://shipeasy.ai";
    ...
    public ApiClient() {
        ...
        authentications.put("bearerSdkKey", new HttpBearerAuth("bearer"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://shipeasy.ai)
     ...
     * @return a {@link ai.shipeasy.admin.ApiClient} object
     */
    ...
    */
     ...
     * @throws ai.shipeasy.admin.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws ai.shipeasy.admin.ApiException If fail to serialize the given object
     */
     ...
     * @throws ai.shipeasy.admin.ApiException If fail to read file content from response and write to disk
     ...
     * @throws ai.shipeasy.admin.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws ai.shipeasy.admin.ApiException If the response has an unsuccessful status code or
     ...
     * @throws ai.shipeasy.admin.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws ai.shipeasy.admin.ApiException If fails to update the parameters
     */
     ...
     * @throws ai.shipeasy.admin.ApiException If fail to serialize the request body object into a string
     */
